...
{
       0,   432,   432,   432,   436,   437,   444,   444,   448,   450,
     452,   454,   456,   458,   460,   467,   468,   471,   473,   475,
     477,   479,   481,   483,   485,   487,   489,   498,   499,   502,
     502,   505,   509,   510,   513,   514,   517,   520,   521,   524,
     526,   531,   532,   536,   535,   540,   541,   544,   545,   546,
     553,   554,   557,   560,   561,   564,   565,   566,   569,   573,
     581,   583,   585,   587,   594,   596,   598,   600,   602,   604,
     606,   608,   610,   612,   614,   616,   618,   620,   622,   624,
     626,   628,   630,   632,   634,   636,   638,   640,   644,   646,
     648,   650,   652,   656,   658,   660,   664,   666,   674,   676,
     678,   680,   682,   684,   686,   690,   697,   698,   701,   703,
     707,   709,   711,   713,   715,   717,   719,   721,   723,   725,
     727,   729,   731,   733,   735,   737,   739,   741,   743,   745,
     747,   749,   751,   753,   755,   757,   759,   761,   765,   767
};
#endif
...
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, void* scanner)
{
  ...
  switch (yytype)
    {
          case 34: /* NUMBER  */
#line 427 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).number); }
#line 1819 "parser.cc" /* yacc.c:1257  */
        break;

    case 112: /* expr  */
#line 426 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).expr); }
#line 1825 "parser.cc" /* yacc.c:1257  */
        break;

    case 113: /* const_rate_expr  */
#line 426 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).expr); }
#line 1831 "parser.cc" /* yacc.c:1257  */
        break;

    case 115: /* arguments  */
#line 428 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).arguments); }
#line 1837 "parser.cc" /* yacc.c:1257  */
        break;

    case 116: /* const_expr  */
#line 426 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).expr); }
#line 1843 "parser.cc" /* yacc.c:1257  */
        break;

    case 120: /* property  */
#line 426 "parser.yy" /* yacc.c:1257  */
      { delete ((*yyvaluep).expr); }
#line 1849 "parser.cc" /* yacc.c:1257  */
        break;
...
#line 771 "parser.yy" /* yacc.c:1906  */
